    ...
    <div className="min-h-screen bg-[#e8edf3] flex justify-center items-start py-6">
      <div className="relative h-[932px] w-[430px] max-w-full overflow-hidden rounded-[38px] bg-[#f7f2ec] shadow-2xl">
        ...
        <main className="h-full overflow-y-auto pb-[105px]">
          <img
            src="/images/Fresh Flowers Garbe 5 Stem M.jpeg"
            alt="Garbe 5 Stem M"
            className="h-[392px] w-full object-cover object-center"
          />
          <section className="mx-5 mt-3 bg-white px-6 py-5">
            <h2 className="text-[26px] font-medium tracking-wide text-[#2f435e]">GARBE 5 STEM (M)</h2>
            <p className="mt-3 text-[17px] text-[#2f435e]">Rp150.000</p>
            <div className="mt-4">
              <p className="text-[16px] text-slate-400">Komposisi:</p>
              <p className="mt-1 text-[16px] tracking-wide text-[#2f435e]">CHRYSAN ASTER, GARBERA, SOLIDAGO/PAKIS/RUSKUS</p>
            </div>
            <div className="mt-4">
              <p className="text-[16px] text-slate-400">Ukuran:</p>
              <div className="mt-2 flex h-11 w-14 items-center justify-center rounded-[12px] bg-[#2f435e] text-[16px] font-medium text-white">M</div>
            </div>
            <div className="mt-4">
...
export default ProductDetailGarbe5Stem;