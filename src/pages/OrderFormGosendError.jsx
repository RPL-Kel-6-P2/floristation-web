      ...
      <div className="mx-auto min-h-screen max-w-[390px] bg-[#f7f1eb] shadow-2xl">
        ...
        <main className="space-y-6 px-4 py-6 pb-10">
          ...
          <section className="rounded-2xl bg-white p-4 space-y-4">
            <h3 className="text-lg font-semibold text-[#2f435e]">Metode Pengambilan</h3>
            ...
            <div>
              ...
              <textarea className="mt-2 w-full h-24 rounded-xl border border-red-500 bg-[#f7f1eb] p-3" />
          ...
          {/* DATA PEMESAN */}
          <section className="rounded-2xl bg-white p-4 space-y-4">
            <h3 className="text-lg font-semibold text-[#2f435e]">Data Pemesan</h3>
            ...
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-red-500 bg-[#f7f1eb] p-3"
              />
              <p className="text-sm text-red-500">
          ...
          {/* DATA PENERIMA */}
          <section className="rounded-2xl bg-white p-4 space-y-4">
            <h3 className="text-lg font-semibold text-[#2f435e]">Data Penerima</h3>
          ...
          <section className="rounded-2xl bg-white p-4">
            ...
            <textarea
              ...
              className="mt-3 h-24 w-full rounded-xl border border-slate-300 bg-[#f7f1eb] p-3"
            />
          </section>
...
export default OrderFormGosendError;