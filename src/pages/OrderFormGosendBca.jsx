      ...
      <div className="mx-auto min-h-screen max-w-[390px] bg-[#f7f1eb] shadow-2xl">
        ...
        <main className="space-y-6 px-4 py-6 pb-10">
          ...
          <section className="rounded-2xl bg-white p-4">
            ...
            <textarea className="mt-2 h-24 w-full rounded-xl border border-slate-300 bg-[#f7f1eb] p-3" />
          </section>
          ...
          <section className="rounded-2xl bg-white p-4">
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-slate-300 bg-[#f7f1eb] p-3"
            />
          </section>
...
export default OrderFormGosendBca;