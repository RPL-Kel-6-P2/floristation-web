...
function Katalog() {
  ...
  return (
    <div className="min-h-screen bg-[#e8edf3] flex justify-center items-start py-6">
      {/* FRAME MOBILE */}
      <div className="relative h-[932px] w-[430px] max-w-full overflow-hidden rounded-[38px] bg-[#f6f1eb] shadow-[0_18px_45px_rgba(39,55,77,0.22)]">
        {/* SCROLL CONTENT */}
        <div className="hide-scrollbar h-full overflow-y-auto pb-[100px]">
          ...
          {/* HERO */}
          <section className="bg-[#eadfd2] px-5 py-8 text-center">
            ...
            <div className="hide-scrollbar flex gap-3 overflow-x-auto whitespace-nowrap scroll-smooth">
              {categories.map((category) => (
                <button
                  ...
                  className={`h-[46px] shrink-0 rounded-[18px] border px-5 text-[13px] font-semibold transition ${
